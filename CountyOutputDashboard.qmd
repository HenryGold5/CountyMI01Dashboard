...
server-ui-wrapper: |
  function(ui) {
    shinymanager::secure_app(ui, enable_admin = FALSE)
  }
editor: visual
execute:
  echo: false
...
presincts <- suppressMessages(sf::st_read("data/Shapefiles/District1PresinctsWithVoting/district1Presincts.gpkg", quiet = TRUE))
overall <- suppressMessages(sf::read_sf("data/Shapefiles/District1Overall/district1Overall.shp"))
metro <- suppressMessages(sf::read_sf("data/Shapefiles/District1Metro/district1Metro.shp"))
counties_all <- suppressMessages(sf::read_sf("data/Shapefiles/District1Counties/district1Counties.shp"))
countyVotingResults_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/votingResultsCountyWide.xlsx"))
voterTurnout_all <- suppressMessages(read.csv("data/ExcelFiles/voterTurnout2024.csv"))
vaSpend_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/spendDataVA.xlsx"))
numEmployees_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/numEmployeesCounty.xlsx"))
numEstablishments_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/numEstablishmentsCounty.xlsx"))
payRoll_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/payRollCounty.xlsx"))
ageSex_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/CountyDemographics.xlsx", sheet = 1))
bachelorType_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/CountyDemographics.xlsx", sheet = 2))
educationAttainment_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/CountyDemographics.xlsx", sheet = 3))
householdIncome_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/CountyDemographics.xlsx", sheet = 4))
medianIncome_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/CountyDemographics.xlsx", sheet = 5))
hispanicLatino_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/CountyDemographics.xlsx", sheet = 6))
race_all <- suppressMessages(readxl::read_xlsx("data/ExcelFiles/CountyDemographics.xlsx", sheet = 7))
educationData_all <- suppressMessages(sf::read_sf("data/Shapefiles/Education/educationDataset.shp"))
...
# Add authentication check at server start
